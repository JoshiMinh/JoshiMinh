...
public class AddScore {
    ...
    public AddScore(String player, double score) {
        ...
        var star = new ImageIcon(new ImageIcon(getClass().getResource("/joshiminh/flappybird/resources/images/star.png")).getImage().getScaledInstance(45, 45, Image.SCALE_DEFAULT));
