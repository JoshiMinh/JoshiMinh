...
public class Launcher {
    ...
    public static void main(String[] args) {
        ...
        nameField.setText(prefs.get(PLAYER_NAME_KEY, ""));

        String[] themes = {"9-11", "Original", "Red Night", "Under Water"};
        ...
        ImageIcon birdIcon = new ImageIcon(Launcher.class.getResource("/joshiminh/flappybird/resources/images/Flappy_Bird_icon.png"));
        ...
        if (result == 0) {
            ...
            prefs.put(PLAYER_NAME_KEY, playerName);
