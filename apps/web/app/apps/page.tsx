...
export const metadata = {
  title: "Apps - Joshi Minh",
  description: "My collection of apps and projects—indie SaaS products and creative experiments.",
};
...
export default async function AppsPage() {
  ...
  return (
    <div className={styles.page}>
      <main>
        <section className={`${styles.section} ${styles.sectionProjects}`} aria-labelledby="apps-heading">
          <div className={styles.sectionIntro}>
            <span className={styles.pill}>Apps</span>
            <h1 id="apps-heading">My Apps &amp; Projects</h1>
            <p>
              A collection of apps and projects I&apos;ve built—from indie SaaS products to creative experiments. Each one
              is a playground for exploring new ideas and technologies.
            </p>
          </div>
